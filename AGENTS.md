...
- Canonical repo target: `kotlin-web-orcid`. Useful entrypoints: `dev project show kotlin-web-orcid`, `dev build kotlin-web-orcid`, `dev check kotlin-web-orcid`.
- Setup-managed files are regenerated with `dev setup kotlin-web-orcid`; avoid hand-editing stamped generated files.
